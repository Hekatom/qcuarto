"""
Django settings for qcuarto project.
...
SECRET_KEY = 'ov18kvu998pq6cuv%q*e!62twka)at36*u#mzp(yz2w^r&&eaq'
...
WSGI_APPLICATION = 'qcuarto.wsgi.application'
